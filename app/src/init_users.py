...
def create_users_and_permissions(
    ...
    db_port="5432",
    db_name="appdb",
    db_user="postgres",  # Modificato da appuser a postgres
    db_password="postgres"  # Modificato con password generica
):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument('--user', default='postgres', help='Utente del database')
    parser.add_argument('--password', default='postgres', help='Password del database')
